        ...
        <ImageListItem key={index}>
          ...
          <ImageListItemBar
            ...
            <ButtonGroup variant="outlined" aria-label="outlined button group">
              ...
              <a href="https://laizy.ai/register/?ref=editimgbutton"><Button startIcon={<EditIcon/>} > Edit</Button></a> {/* Tady by mohl byt dropdown "edit in canva" / edit in "3rd party" */}
              <a href="https://laizy.ai/register/?ref=saveimgbutton"><Button startIcon={<SaveAltIcon/>} onClick={ () => { saveOutputImage( index  ) }  }> Save</Button></a>
              <a href="https://laizy.ai/register/?ref=shareimgbuton"><Button startIcon={<ShareIcon/>} > Share</Button></a>
            </ButtonGroup>
            }
            //subtitle={}
            position="below"
